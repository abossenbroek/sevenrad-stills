		...
		"boxes" : [ 			{
			...
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.0, 130.0, 65.0, 22.0 ],
					"text" : "qmetro 30"
				}
			},
			{
			...
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 100.0, 200.0, 20.0 ],
					"text" : "sigma: 0.0 - 50.0"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 450.0, 125.0, 60.0, 22.0 ],
					"minimum" : 0.0,
					"maximum" : 50.0
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 155.0, 80.0, 22.0 ],
					"text" : "sigma $1"
				}
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 200.0, 150.0, 20.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 30.0, 220.0, 200.0, 22.0 ],
					"text" : "jit.gl.pix @gen sr.blur.h @sigma 5.0"
				}
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 260.0, 150.0, 20.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 30.0, 280.0, 200.0, 22.0 ],
					"text" : "jit.gl.pix @gen sr.blur.v @sigma 5.0"
				}
			},
			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 340.0, 320.0, 180.0 ]
				}
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 340.0, 300.0, 100.0 ],
