{
	"patcher" : 	{
		...
		"boxes" : [
			...
			{ "box" : { "id" : "obj-world", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 550.0, 130.0, 120.0, 22.0 ], "text" : "jit.world sr.ctx @visible 0" } },
			...
			{ "box" : { "id" : "obj-5", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "jit_gl_texture", "" ], "patching_rect" : [ 30.0, 160.0, 350.0, 22.0 ], "text" : "jit.movie @autostart 1 @loop 1 @output_texture 1 @drawto sr.ctx" } },
			{ "box" : { "id" : "obj-20", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 1, "outlettype" : [ "bang" ], "patching_rect" : [ 400.0, 130.0, 58.0, 22.0 ], "text" : "loadbang" } },
			...
			{ "box" : { "id" : "obj-7", "maxclass" : "newobj", "numinlets" : 2, "numoutlets" : 2, "outlettype" : [ "jit_gl_texture", "" ], "patching_rect" : [ 30.0, 210.0, 350.0, 22.0 ], "text" : "jit.gl.pix sr.ctx @gen sr.bandswap @perm_r 2 @perm_g 1 @perm_b 0" } },
