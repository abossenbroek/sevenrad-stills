		...
		"boxes" : [ 			{
			...
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 45.0, 600.0, 60.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 250.0, 150.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 180.0, 120.0, 22.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 120.0, 300.0, 80.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 450.0, 210.0, 50.0, 22.0 ],
					"minimum" : 0,
					"maximum" : 3
				}
			},
			...
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 220.0, 180.0, 20.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 30.0, 240.0, 210.0, 22.0 ],
					"text" : "jit.gl.pix @gen sr.bayer.mosaic @pattern 0"
				}
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 280.0, 200.0, 20.0 ],
			...
			},
			{
				"box" : 				{
					...
					"text" : "jit.gl.pix @gen sr.bayer.demosaic @pattern 0"
				}
			},
			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 360.0, 320.0, 180.0 ]
				}
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 360.0, 300.0, 100.0 ],
