{
	"patcher" : 	{
		...
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 30.0, 20.0, 400.0, 20.0 ], "text" : "sr.blur.circular - Circular Disk Blur", "fontsize" : 14.0, "fontface" : 1 } },
			{ "box" : { "id" : "obj-2", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 30.0, 45.0, 500.0, 40.0 ], "text" : "Creates bokeh-like blur using uniform circular disk averaging.\nDifferent from Gaussian blur - no edge falloff, sharp circular shape." } },
			...
			{ "box" : { "id" : "obj-6", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 400.0, 100.0, 150.0, 20.0 ], "text" : "radius: 0-30 pixels" } },
			{ "box" : { "id" : "obj-7", "maxclass" : "number", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "", "bang" ], "patching_rect" : [ 400.0, 125.0, 50.0, 22.0 ], "minimum" : 0, "maximum" : 30 } },
			{ "box" : { "id" : "obj-8", "maxclass" : "message", "numinlets" : 2, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [ 400.0, 155.0, 80.0, 22.0 ], "text" : "radius $1" } },
			{ "box" : { "id" : "obj-9", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "jit_gl_texture", "" ], "patching_rect" : [ 30.0, 210.0, 280.0, 22.0 ], "text" : "jit.gl.pix @gen sr.blur.circular @radius 7" } },
			{ "box" : { "id" : "obj-10", "maxclass" : "jit.pwindow", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "jit_matrix", "" ], "patching_rect" : [ 30.0, 260.0, 320.0, 180.0 ] } },
			{ "box" : { "id" : "obj-11", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 400.0, 260.0, 250.0, 60.0 ], "text" : "Performance note:\nO(r^2) per pixel - may be slow for large radii.\nConsider separable Gaussian blur for large sigma." } }
		],
		"lines" : [
