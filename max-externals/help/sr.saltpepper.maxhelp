{
	"patcher" : 	{
		...
		"description" : "Salt and pepper noise effect",
		"digest" : "Random white (salt) and black (pepper) pixel artifacts",
		"tags" : "jitter, GPU, noise, salt, pepper, effect",
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 30.0, 20.0, 400.0, 20.0 ], "text" : "sr.saltpepper - Salt and Pepper Noise", "fontsize" : 14.0, "fontface" : 1 } },
			{ "box" : { "id" : "obj-2", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 30.0, 45.0, 500.0, 40.0 ], "text" : "Random pixels replaced with white (salt) or black (pepper).\nSimulates dead pixels, transmission errors, or cosmic ray hits." } },
			...
			{ "box" : { "id" : "obj-9", "maxclass" : "comment", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 520.0, 100.0, 150.0, 20.0 ], "text" : "salt_ratio: 0.0-1.0" } },
			...
			{ "box" : { "id" : "obj-11", "maxclass" : "message", "numinlets" : 2, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [ 520.0, 155.0, 100.0, 22.0 ], "text" : "salt_ratio $1" } },
			{ "box" : { "id" : "obj-12", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "jit_gl_texture", "" ], "patching_rect" : [ 30.0, 210.0, 350.0, 22.0 ], "text" : "jit.gl.pix @gen sr.saltpepper @amount 0.05 @salt_ratio 0.5" } },
