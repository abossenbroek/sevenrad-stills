		...
		"boxes" : [ 			{
			...
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 45.0, 500.0, 40.0 ],
			...
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 100.0, 200.0, 20.0 ],
					"text" : "factor: 0.0 - 3.0"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 400.0, 125.0, 60.0, 22.0 ],
					"minimum" : 0.0,
					"maximum" : 3.0
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 155.0, 80.0, 22.0 ],
					"text" : "factor $1"
				}
			},
			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 210.0, 280.0, 22.0 ],
					"text" : "jit.gl.pix @gen sr.saturation @factor 1.0"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 30.0, 260.0, 320.0, 180.0 ]
				}
			},
			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 260.0, 250.0, 80.0 ],
					"text" : "Preset buttons:"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 290.0, 80.0, 22.0 ],
					"text" : "factor 0.0"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.0, 290.0, 80.0, 22.0 ],
					"text" : "factor 1.0"
				}
			},
			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 580.0, 290.0, 80.0, 22.0 ],
					"text" : "factor 2.0"
				}
			}
		],
