"""Tests for GPU-accelerated saturation operation."""
...
class TestSaturationGPUOperation:
    ...
    @pytest.fixture
    def operation(self) -> SaturationGPUOperation:
        """Create a GPU saturation operation instance."""
        return SaturationGPUOperation()
    ...
    def test_operation_name(self, operation: SaturationGPUOperation) -> None:
        """Test operation has correct name."""
        assert operation.name == "saturation_gpu"

    def test_valid_params_fixed(self, operation: SaturationGPUOperation) -> None:
    ...
    def test_valid_params_random(self, operation: SaturationGPUOperation) -> None:
        """Test valid parameter validation for random mode."""
        params = {"mode": "random", "range": [-0.5, 0.5]}
        operation.validate_params(params)  # Should not raise

    def test_missing_mode_raises_error(self, operation: SaturationGPUOperation) -> None:
    ...
    def test_invalid_mode_raises_error(self, operation: SaturationGPUOperation) -> None:
    ...
    def test_missing_value_in_fixed_mode_raises_error(
        self, operation: SaturationGPUOperation
    ) -> None:
    ...
    def test_apply_fixed_increase_saturation(
        self, operation: SaturationGPUOperation, test_image: Image.Image
    ) -> None:
        """Test applying fixed saturation increase."""
        params = {"mode": "fixed", "value": 0.5}
    ...
    def test_apply_fixed_decrease_saturation(
        ...
        """Test applying fixed saturation decrease."""
        params = {"mode": "fixed", "value": -0.5}
        result = operation.apply(test_image, params)
        assert isinstance(result, Image.Image)
        assert result.size == test_image.size
    ...
    def test_apply_grayscale(
        ...
        """Test converting to grayscale (saturation = 0)."""
    ...
    def test_apply_random_mode(
        ...
        """Test applying random saturation adjustment."""
