...
class TestBandSwapGPUOperation:
    ...
    @pytest.fixture
    def operation(self) -> BandSwapGPUOperation:
        """Create a GPU band swap operation instance."""
        return BandSwapGPUOperation()
    ...
    def test_operation_name(self, operation: BandSwapGPUOperation) -> None:
        """Test operation has correct name."""
        assert operation.name == "band_swap_gpu"

    def test_valid_params(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_valid_params_with_all_options(
        self, operation: BandSwapGPUOperation
    ) -> None:
    ...
    def test_apply_basic(
        self, operation: BandSwapGPUOperation, test_image: Image.Image
    ) -> None:
        """Test applying GPU band swap."""
        params = {"tile_count": 5, "permutation": "GRB", "seed": 42}
    ...
    def test_apply_produces_change(
        ...
        """Test that GPU band swap actually changes the image."""
    ...
    def test_grb_permutation_correctness(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_bgr_permutation_correctness(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_rbg_permutation_correctness(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_apply_preserves_rgba_alpha(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_grayscale_raises_error(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_zero_tile_count_edge_case(
        self,
        operation: BandSwapGPUOperation,
    ...
    def test_all_permutations_are_valid(self, operation: BandSwapGPUOperation) -> None:
    ...
    def test_gpu_produces_valid_output(self, test_image: Image.Image) -> None:
        ...
        # Due to band swapping, we should see variation in the image
        # (not all pixels identical to input)
        original_array = np.array(test_image)
