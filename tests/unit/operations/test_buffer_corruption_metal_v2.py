...
from sevenrad_stills.operations.buffer_corruption_metal_v2 import (  # noqa: E402
    BufferCorruptionMetalV2,
)
...
def metal_v2_operation():
    ...
    try:
        return BufferCorruptionMetalV2()
    except (ImportError, RuntimeError, FileNotFoundError) as e:
        pytest.skip(f"Metal v2 not available: {e}")


class TestBufferCorruptionMetalV2:
