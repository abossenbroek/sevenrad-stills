"""Type rules (T): Operator type compatibility validation."""
...
class TypeCompatibilityRule(LintRule):
    """
    T001: Check type compatibility between connected operators.
    ...
    def _is_compatible(
        ...
        return target_op_type.lower() in converter_types
